...
import postsPageInitialPaths7f042Resource from '../../../resources/posts-page-initial-paths-7f042'
import postsPageInitialPropsEd611Resource from '../../../resources/posts-page-initial-props-ed611'
...
export async function getStaticPaths() {
  try {
    const response = await postsPageInitialPaths7f042Resource({})
...
export async function getStaticProps(context) {
  try {
    const response = await postsPageInitialPropsEd611Resource({
      ...context?.params,
